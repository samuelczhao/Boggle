...
public class BoggleGame extends JFrame {
    ...
    public static void main(final String[] args) {
    	...
    	final int BOARD_COLUMNS = 4;
        
        SwingUtilities.invokeLater(new Runnable() {
            public void run() {
                new BoggleGame(BOARD_ROWS, BOARD_COLUMNS).setVisible(true);
            }
        });
    }
